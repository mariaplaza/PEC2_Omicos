...
```{r echo=FALSE, fig.cap='Gráfico MD de las 30 muestras', fig.height=4.5, message=FALSE, warning=FALSE, tidy=TRUE}
par(mfrow=c(3,2))
...
*Subconjustamos* la tabla de resultados a estos genes y luego los clasificamos por la estimación del log2change para obtener los genes significativos con la regulación descendente mínima:
